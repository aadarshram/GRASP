'''
Model architecture putting together all components of Llava Pythia.
'''
...
from .language_model.pythia.configuration_llava_pythia import LlavaPythiaVisionConfig, ProjectorConfig
...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        '''
        Follows Llava framework for preparing inputs and labels for multimodal LLMs.
        '''

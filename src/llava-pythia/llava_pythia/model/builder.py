'''
Builder to load a pretrained Llava-Pythia model with optional quantization and device mapping. Puts together CLIP/Siglip vision encoder, multimodal projector, and language model (LLaVA-Pythia).
'''
